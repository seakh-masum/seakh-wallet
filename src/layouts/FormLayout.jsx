...
const FormLayout = ({ title, children, handleSubmit, isValid, buttonTitle = 'Save', buttonType, hasAnotherButton = false, secondBtnTitle = 'Save', secondBtnValid, secondBtnType }) => {
  return (
    <div className="relative flex flex-col min-h-screen h-full bg-neutral-100 px-3 py-5 dark:bg-neutral-950">
      ...
      <div className="fixed z-50 bottom-0 left-0 right-0 p-3 dark:bg-neutral-950">
        <div className='flex flex-row gap-2'>
          ...
          {hasAnotherButton && <Button onClick={handleSubmit} disabled={secondBtnValid} title={secondBtnTitle} type={secondBtnType} />}
        </div>
      </div>
    </div>
  );
